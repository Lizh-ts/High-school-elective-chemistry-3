...
## 動機
在化學課時老師上到酸鹼滴定，老師問我是否能寫出一個程式，計算酸鹼滴定的pH值並繪圖，像簡報上呈現的一樣。

## 過程
我用大約2個小時構思並編程，並參考講義上的公式。然後寫到一半就發現有問題，在酸滴定鹼時會有圖形跑掉或根本不符，在和老師從原理推倒並check講義後，發現是講義的的公式有誤。

## 心得
經過這次我發現，原來講義也會犯這種錯誤。這個程式我也分享給化學老師，讓之後的實驗結果若要對齊或比較時可以使用這個程式的結果；同時我也發現Python在科學計算的方便之處，使我在短時間內就處理好這個專案。過程中因為與老師討論以及理論推倒，使我對該章節的平衡算法與莫爾濃度更為熟悉，同時也救回我的化學期末考。
...
# 關於期末考的部分
考完會有兩種"ㄨㄢˊ "，一個是"玩"樂，另一個可想而知一定是"完"蛋。<br>
